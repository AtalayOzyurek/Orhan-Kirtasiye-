<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
			...
			$slider = resimUpload($_FILES["resim"], "", false, "images/vizyongaleri", "870,600");
			
			$sutunlar = array("resim", "baslik", "aciklama");
			$veriler = array($slider, $baslik, $aciklama);
			
			if(veriEkle($sutunlar, $veriler, "vizyonumuz"))
				islemKaydi("vizyonumuz", "vizyonumuz resim ekledi.");
			git("?islem=liste");
		}
		...
		if($_GET["islem"] == "resimduzenle"){
			...
			{
				$eski = veriCek("vizyonumuz", "resim", "id", $slider_id);
				$slider = resimUpload($_FILES["resim"], $eski["resim"], false, "/images/vizyongaleri", "870,600");
				
				array_push($sutunlar, "resim");
				array_push($veriler, $slider);
			}
			
			if(veriGuncelle($sutunlar, $veriler, "vizyonumuz", "id", $slider_id))
				islemKaydi("vizyonumuz", "vizyonumuz resmini güncelledi.");
			...
			<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
							 ...
							 <form action="?islem=resimekle" id="validation-form" enctype="multipart/form-data" method="POST" class="form-horizontal form-bordered form-row-stripped">
								<div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  ...
									  <p>
									  - <b style="color: red">(Width) Genişlik : 870Px (Piksel)</b>
									  <br />
									  - <b style="color: red">(Height) Yükseklik : 600Px (Piksel)</b>
									  </p>
								   </div>
								</div>	
								<div class="form-group">
						...
						break;
						case "duzenle":
						$getSlider = veriCek("vizyonumuz", "*", "id", $_GET["id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						  <div class="box-title">
							 <h3><i class="fa fa-bars"></i> Vizyonumuz Düzenle</h3>
							 <div class="box-tool">
								<a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
								<a data-action="close" href="#"><i class="fa fa-times"></i></a>
							 </div>
						  ...
						  <div class="box-content">
							 <form action="?islem=resimduzenle" id="validation-form" enctype="multipart/form-data" method="POST" class="form-horizontal form-bordered form-row-stripped">
								...
								<div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  <a target="_blank" href="../images/vizyongaleri<?=$getSlider["resim"]?>"> <img src="../images/vizyongaleri/<?=$getSlider["resim"]?>" style="max-width: 50%;" /> </a>
								...
								<div class="form-group">
								   <label for="kadi" class="col-sm-3 col-lg-2 control-label">Vizyon Başlığı</label>
								   <div class="col-sm-9 col-lg-10 controls">
				...
				<div class="row">
				   <div class="col-md-12">
					  <div class="box">
						 <div class="box-title">
							<h3><i class="fa fa-table"></i> Ana Vizyonumuz Listesi</h3>
							<div class="box-tool">
							   <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
							   <a data-action="close" href="#"><i class="fa fa-times"></i></a>
							</div>
						 ...
						 <div class="box-content">
							   ...
							   <table class="table table-striped table-hover fill-head">
								  ...
								  <tbody id="sortable" target="vizyonumuz">
									 <?php
									 $veri = tabloCek("vizyonumuz", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
									 ?>
									 <tr id="item-<?=$row["id"];?>">
										<td class="sortable"><?=$i;?></td>
										<td><a target="_blank" href="../images/vizyongaleri/<?=$row["resim"];?>"><img src="../images/vizyongaleri/<?=$row["resim"];?>" height="120px" /></td>
										<td><?=$row["baslik"];?></td>
						...
						case "sil":
						{
							if(ctype_digit($_GET["id"])) {
								$getOldImg = veriCek("vizyonumuz", "id, resim", "id", $_GET["id"]);
							
								veriSil("vizyonumuz", "id", $_GET['id']);
								islemKaydi("vizyonumuz Listesi", "bir vizyonumuz resimi sildi.");
								
								@unlink("../images/vizyongaleri" . $getOldImg["img"]);
							}
						}
						git("?islem=liste");
						break;
