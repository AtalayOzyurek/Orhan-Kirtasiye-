<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
			...
			if(veriEkle($sutunlar, $veriler, "bio"))
				islemKaydi("bio", "yazı ekledi.");
			git("?islem=liste");
		}
		...
		if($_GET["islem"] == "resimduzenle"){
			...
			{
				$eski = veriCek("bio", "resim", "id", $slider_id);
				$slider = resimUpload($_FILES["resim"], $eski["resim"], false, "images/bio", "800,550");
            ...
            if(veriGuncelle($sutunlar, $veriler, "bio", "id", $slider_id))
            islemKaydi("bio", "bio resmi güncellendi.");
			...
			if(veriGuncelle($sutunlar, $veriler, "bio", "id", $slider_id))
				islemKaydi("bio", "bio resmini güncelledi.");
			...
			<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						...
						break;
						case "duzenle":
						$getSlider = veriCek("bio", "*", "id", $_GET["Id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						  ...
						  <div class="box-content">
							 <form action="?islem=resimduzenle" id="validation-form" enctype="multipart/form-data" method="POST" class="form-horizontal form-bordered form-row-stripped">
                                ...
                                <div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  <a target="_blank" href="../images/bio/<?=$getSlider["resim"]?>"> <img src="../images/bio/<?=$getSlider["resim"]?>" style="max-width: 50%;" /> </a>
				...
				<div class="row">
				   <div class="col-md-12">
					  <div class="box">
						 <div class="box-title">
							<h3><i class="fa fa-table"></i> bio Ekle </h3>
							<div class="box-tool">
							   <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
							   <a data-action="close" href="#"><i class="fa fa-times"></i></a>
							</div>
						 ...
						 <div class="box-content">
							<button type="button" class="btn btn-primary" onclick="javascript:location.href='?islem=ekle';"><i class="fa fa-check"></i> Yeni bio Ekle</button>
							...
							<div class="table-responsive">
							   <table class="table table-striped table-hover fill-head">
								  ...
								  <tbody id="sortable" target="bio">
									 <?php
									 $veri = tabloCek("bio", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
                    ...
                    case "ssssil":
                    {
                        if(ctype_digit($_GET["Id"])) {
                            ...
                            veriSil("bio", "id", $_GET['Id']);
                            islemKaydi("bio Listesi", "bir haber sildi.");
