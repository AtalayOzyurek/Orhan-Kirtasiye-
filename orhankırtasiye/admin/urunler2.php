<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
            ...
            $resim = resimUpload($_FILES["resim"], "", false, "images/urunler2", "325,300");
			
			$sutunlar = array("resim", "baslik", "aciklama", "kategori");
			$veriler = array($resim, $baslik, $aciklama, $kategori);
			
			if(veriEkle($sutunlar, $veriler, "urunler2"))
		...
		if($_GET["islem"] == "resimduzenle"){
			...
			{
				$eski = veriCek("urunler2", "resim", "id", $slider_id);
				$slider = resimUpload($_FILES["resim"], $eski["resim"], false, "images/urunler2", "325,300");
            ...
            if(veriGuncelle($sutunlar, $veriler, "urunler2", "id", $slider_id))
            islemKaydi("urunler2", "urunler2 resmi güncellendi.");
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
                             ...
                             <div class="form-group">
								...
								<div class="form-group">
								   ...
								   <select name="kategori" class="form-control">
										  <?php
												$kategoriler = tabloCek("urunler_kategori2", "*", "");

												foreach($kategoriler as $data) {
													echo "<option value=\"{$data["baslik"]}\">{$data["baslik"]}</option>";
												}
										  ?>
									  </select>
								   </div>
						...
						break;
						case "duzenle":
						$getSlider = veriCek("urunler2", "*", "id", $_GET["id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						  ...
						  <div class="box-content">
							 <form action="?islem=resimduzenle" id="validation-form" enctype="multipart/form-data" method="POST" class="form-horizontal form-bordered form-row-stripped">
                                ...
                                <div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  <a target="_blank" href="../images/urunler2/<?=$getSlider["resim"]?>"> <img src="../images/urunler2/<?=$getSlider["resim"]?>" style="max-width: 50%;" /> </a>
						 ...
						 <div class="box-content">
							...
							<div class="table-responsive">
							   <table class="table table-striped table-hover fill-head">
								  ...
								  <tbody id="sortable" target="urunler2">
									 <?php
									 $veri = tabloCek("urunler2", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
										$kategori = veriCek("urunler_kategori2", "*", "id", $row["kategori"]);
									 ?>
									 <tr id="item-<?=$row["id"];?>">
                                        <td class="sortable"><?=$i;?></td>
                                        <td><a target="_blank" href="../images/urunler2/<?=$row["resim"];?>"><img src="../images/urunler2/<?=$row["resim"];?>" height="120px" /></td>
										<td><?=$row["baslik"];?></td>
