<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
			...
			if(veriEkle($sutunlar, $veriler, "hakkimizda2"))
		...
		if($_GET["islem"] == "resimduzenle"){
			...
			{
				$eski = veriCek("hakkimizda2", "resim", "id", $slider_id);
			...
			if(veriGuncelle($sutunlar, $veriler, "hakkimizda2", "id", $slider_id))
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						...
						break;
						case "duzenle":
						$getSlider = veriCek("hakkimizda2", "*", "id", $_GET["Id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
				   ...
				   <div class="col-md-12">
					  <div class="box">
						 <div class="box-title">
							...
							<div class="box-tool">
								<div></div>
								<a class="btn btn-success" href="">Ekle</a>
							   <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
							   <a data-action="close" href="#"><i class="fa fa-times"></i></a>
							</div>
						 </div>
						 <div class="box-content">
							   ...
							   <table class="table table-striped table-hover fill-head">
								  ...
								  <tbody id="sortable" target="hakkimizda2">
									 <?php
									 $veri = tabloCek("hakkimizda2", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
									 ?>
									 <tr id="item-<?=$row["id"];?>">
						...
						case "sil":
						{
							if(ctype_digit($_GET["Id"])) {
								$getOldImg = veriCek("hakkimizda2", "id, resim", "id", $_GET["Id"]);
							
								veriSil("hakkimizda2", "id", $_GET['Id']);
