<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
            ...
            $resim = resimUpload($_FILES["resim"], "", false, "images/haberler", "800,550");
			
			$sutunlar = array("resim", "baslik", "aciklama");
			$veriler = array($resim, $baslik, $aciklama);
			
			if(veriEkle($sutunlar, $veriler, "haberler"))
				islemKaydi("haberler", "yazı ekledi.");
			git("?islem=liste");
		}
		...
		if($_GET["islem"] == "resimduzenle"){
			...
			{
				$eski = veriCek("haberler", "resim", "id", $slider_id);
				$slider = resimUpload($_FILES["resim"], $eski["resim"], false, "images/haberler", "800,550");
            ...
            if(veriGuncelle($sutunlar, $veriler, "haberler", "id", $slider_id))
            islemKaydi("haberler", "haberler resmi güncellendi.");
			...
			if(veriGuncelle($sutunlar, $veriler, "haberler", "id", $slider_id))
				islemKaydi("haberler", "haberler resmini güncelledi.");
			...
			<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						...
						break;
						case "duzenle":
						$getSlider = veriCek("haberler", "*", "id", $_GET["Id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						  <div class="box-title">
							 <h3><i class="fa fa-bars"></i>Haber Düzenle</h3>
							 <div class="box-tool">
								<a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
								<a data-action="close" href="#"><i class="fa fa-times"></i></a>
							 </div>
						  ...
						  <div class="box-content">
							 <form action="?islem=resimduzenle" id="validation-form" enctype="multipart/form-data" method="POST" class="form-horizontal form-bordered form-row-stripped">
                                ...
                                <div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  <a target="_blank" href="../images/haberler/<?=$getSlider["resim"]?>"> <img src="../images/haberler/<?=$getSlider["resim"]?>" style="max-width: 50%;" /> </a>
				...
				<div class="row">
				   <div class="col-md-12">
					  <div class="box">
						 <div class="box-title">
							<h3><i class="fa fa-table"></i> Haber Listesi</h3>
							<div class="box-tool">
							   <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
							   <a data-action="close" href="#"><i class="fa fa-times"></i></a>
							</div>
						 ...
						 <div class="box-content">
							<button type="button" class="btn btn-primary" onclick="javascript:location.href='?islem=ekle';"><i class="fa fa-check"></i> Yeni Haber Ekle</button>
							   ...
							   <table class="table table-striped table-hover fill-head">
								  <thead>
									 <tr>
										...
										<th style="width: 0%">Başlık</th>
                                        <th style="width: 5%">İçerik</th>
									
										
										<th style="width: 25%">İşlem</th>
									 </tr>
								  </thead>
								  <tbody id="sortable" target="haberler">
									 <?php
									 $veri = tabloCek("haberler", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
									 ...
									 <tr id="item-<?=$row["id"];?>">
                                        ...
                                        <td><a target="_blank" href="../images/haberler/<?=$row["resim"];?>"><img src="../images/haberler/<?=$row["resim"];?>" height="120px" /></td>
										<td><?=$row["baslik"];?></td>
                    ...
                    case "ssssil":
                    {
                        if(ctype_digit($_GET["Id"])) {
                            ...
                            veriSil("haberler", "id", $_GET['Id']);
                            islemKaydi("haberler Listesi", "bir haber sildi.");
