<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
			...
			$slider = resimUpload($_FILES["resim"], "", false, "images/misyongaleri", "870,600");
			
			$sutunlar = array("resim", "baslik", "aciklama");
			$veriler = array($slider, $baslik, $aciklama);
			
			if(veriEkle($sutunlar, $veriler, "misyonumuz"))
				islemKaydi("misyonumuz", "misyonumuz resim ekledi.");
			git("?islem=liste");
		}
		...
		if($_GET["islem"] == "resimduzenle"){
			...
			{
				$eski = veriCek("misyonumuz", "resim", "id", $slider_id);
				$slider = resimUpload($_FILES["resim"], $eski["resim"], false, "/images/misyongaleri", "870,600");
				
				array_push($sutunlar, "resim");
				array_push($veriler, $slider);
			}
			
			if(veriGuncelle($sutunlar, $veriler, "misyonumuz", "id", $slider_id))
				islemKaydi("misyonumuz", "misyonumuz resmini güncelledi.");
			...
			<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						...
						break;
						case "duzenle":
						$getSlider = veriCek("misyonumuz", "*", "id", $_GET["id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						  <div class="box-title">
							 <h3><i class="fa fa-bars"></i> Misyonumuz Düzenle</h3>
							 <div class="box-tool">
								<a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
								<a data-action="close" href="#"><i class="fa fa-times"></i></a>
							 </div>
						  ...
						  <div class="box-content">
							 <form action="?islem=resimduzenle" id="validation-form" enctype="multipart/form-data" method="POST" class="form-horizontal form-bordered form-row-stripped">
								...
								<div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  <a target="_blank" href="../images/misyongaleri<?=$getSlider["resim"]?>"> <img src="../images/misyongaleri/<?=$getSlider["resim"]?>" style="max-width: 50%;" /> </a>
								...
								<div class="form-group">
								   <label for="kadi" class="col-sm-3 col-lg-2 control-label">Misyon Başlığı</label>
								   <div class="col-sm-9 col-lg-10 controls">
				...
				<div class="row">
				   <div class="col-md-12">
					  <div class="box">
						 <div class="box-title">
							<h3><i class="fa fa-table"></i> Ana Misyonumuz Listesi</h3>
							<div class="box-tool">
							   <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
							   <a data-action="close" href="#"><i class="fa fa-times"></i></a>
							</div>
						 ...
						 <div class="box-content">
							   ...
							   <table class="table table-striped table-hover fill-head">
								  ...
								  <tbody id="sortable" target="misyonumuz">
									 <?php
									 $veri = tabloCek("misyonumuz", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
									 ?>
									 <tr id="item-<?=$row["id"];?>">
										<td class="sortable"><?=$i;?></td>
										<td><a target="_blank" href="../images/misyongaleri/<?=$row["resim"];?>"><img src="../images/misyongaleri/<?=$row["resim"];?>" height="120px" /></td>
										<td><?=$row["baslik"];?></td>
						...
						case "sil":
						{
							if(ctype_digit($_GET["id"])) {
								$getOldImg = veriCek("misyonumuz", "id, resim", "id", $_GET["id"]);
							
								veriSil("misyonumuz", "id", $_GET['id']);
								islemKaydi("misyonumuz Listesi", "bir misyonumuz resimi sildi.");
								
								@unlink("../images/misyongaleri" . $getOldImg["img"]);
							}
						}
						git("?islem=liste");
						break;
