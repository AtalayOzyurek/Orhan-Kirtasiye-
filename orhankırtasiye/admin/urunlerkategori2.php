<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
			...
			if(veriEkle($sutunlar, $veriler, "urunler_kategori2"))
				islemKaydi("urunler_kategori2", "yazı ekledi.");
			git("?islem=liste");
		}
		...
		if($_GET["islem"] == "resimduzenle"){
            ...
            if(veriGuncelle($sutunlar, $veriler, "urunler_kategori2", "id", $slider_id))
            islemKaydi("urunler_kategori2", "urunler_kategori2 resmi güncellendi.");
			...
			if(veriGuncelle($sutunlar, $veriler, "urunler_kategori2", "id", $slider_id))
				islemKaydi("urunler_kategori2", "urunler_kategori2 resmini güncelledi.");
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						...
						break;
						case "duzenle":
						$getSlider = veriCek("urunler_kategori2", "*", "id", $_GET["id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
				   ...
				   <div class="col-md-12">
						 ...
						 <div class="box-content">
							...
							<div class="table-responsive">
							   <table class="table table-striped table-hover fill-head">
								  ...
								  <tbody id="sortable" target="urunler_kategori2">
									 <?php
									 $veri = tabloCek("urunler_kategori2", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
                    ...
                    case "ssssil":
                    {
                        if(ctype_digit($_GET["id"])) {
                            ...
                            veriSil("urunler_kategori2", "id", $_GET['id']);
