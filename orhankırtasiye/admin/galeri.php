<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){		
		if($_GET["islem"] == "resimekle"){
            ...
            $resim = resimUpload($_FILES["resim"], "", false, "images/galeri", "800,600");
			
			$sutunlar = array("resim", "baslik");
			$veriler = array($resim, $baslik);
			
			if(veriEkle($sutunlar, $veriler, "galeri"))
				islemKaydi("galeri", "yazı ekledi.");
			git("?islem=liste");
		}
		...
		if($_GET["islem"] == "resimduzenle"){
			...
			{
				$eski = veriCek("galeri", "resim", "id", $slider_id);
				$slider = resimUpload($_FILES["resim"], $eski["resim"], false, "images/galeri", "800,600");
            ...
            if(veriGuncelle($sutunlar, $veriler, "galeri", "id", $slider_id))
            islemKaydi("galeri", "galeri resmi güncellendi.");
			...
			if(veriGuncelle($sutunlar, $veriler, "galeri", "id", $slider_id))
				islemKaydi("galeri", "galeri resmini güncelledi.");
			...
			<div id="main-content">
				...
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						  <div class="box-title">
							 <h3><i class="fa fa-bars"></i> Yeni galeri Ekle</h3>
							 <div class="box-tool">
						  ...
						  <div class="box-content">
                             ...
                             <div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  ...
									  <br />
									  - <b>(Height) Yükseklik : 600Px (Piksel)</b>
									  </p>
								   </div>
								</div>
						...
						break;
						case "duzenle":
						$getSlider = veriCek("galeri", "*", "id", $_GET["Id"]);
							?>
				<div class="row">
					<div class="col-md-12">
					   <div class="box box-blue">
						  <div class="box-title">
							 <h3><i class="fa fa-bars"></i>Galeri Düzenle</h3>
							 <div class="box-tool">
								<a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
								<a data-action="close" href="#"><i class="fa fa-times"></i></a>
							 </div>
						  ...
						  <div class="box-content">
							 <form action="?islem=resimduzenle" id="validation-form" enctype="multipart/form-data" method="POST" class="form-horizontal form-bordered form-row-stripped">
                                ...
                                <div class="form-group">
								   ...
								   <div class="col-sm-9 col-lg-10 controls">
									  <a target="_blank" href="../images/galeri/<?=$getSlider["resim"]?>"> <img src="../images/galeri/<?=$getSlider["resim"]?>" style="max-width: 50%;" /> </a>
				...
				<div class="row">
				   <div class="col-md-12">
					  <div class="box">
						 <div class="box-title">
							<h3><i class="fa fa-table"></i> Galeri Listesi</h3>
							<div class="box-tool">
							   <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
							   <a data-action="close" href="#"><i class="fa fa-times"></i></a>
							</div>
						 ...
						 <div class="box-content">
							<button type="button" class="btn btn-primary" onclick="javascript:location.href='?islem=ekle';"><i class="fa fa-check"></i> Yeni Galeri Ekle</button>
							...
							<div class="table-responsive">
							   <table class="table table-striped table-hover fill-head">
								  ...
								  <tbody id="sortable" target="galeri">
									 <?php
									 $veri = tabloCek("galeri", "*", "ORDER BY id ASC");
									 $i=1;
									 foreach( $veri as $row ) {
									 ...
									 <tr id="item-<?=$row["id"];?>">
                                        ...
                                        <td><a target="_blank" href="../images/galeri/<?=$row["resim"];?>"><img src="../images/galeri/<?=$row["resim"];?>" height="120px" /></td>
										<td><?=$row["baslik"];?></td>	
										<td width="400">
                    ...
                    case "ssssil":
                    {
                        if(ctype_digit($_GET["Id"])) {
                            ...
                            veriSil("galeri", "id", $_GET['Id']);
                            islemKaydi("galeri Listesi", "bir galeri sildi.");
