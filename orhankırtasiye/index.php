    ...
    <div class="container" >
      <div class="row " >
        <div class=" col-sm-12 col-md-12 col-lg-3 col-xl-3 "  >
            <div class="kategori border  pt-3 shadow-lg p-3 mb-5 bg-white rounded"> 
              ...
              <?php
									 ...
									 ?>
                <li class="kathov mb-2"><a class="rounded-pill linkk text-dark yazıı mb-2" href="kategoridetay.php?id=<?=$row["id"];?>"><?=$row["baslik"];?></a></li>
                <?php
									 $i++;
									 }
							?>
        ...
        <div class=" col-sm-12 col-md-12 col-lg-9 col-xl-9 ">
          ...
          <?php
									 $veri = tabloCek("urunlerr", "*", "ORDER BY id DESC");
									 $i=1;
									 foreach( $veri as $row ) {
          ...
          <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width: 18rem;" >
                ...
                <p class="card-text  d-block mb-3 mx-3  "> <a  class="text-dark linkk kutu" href="kategoridetay.php?id=<?=$kategori["id"];?>">  <?=$kategori["baslik"];?> </a> </p>
